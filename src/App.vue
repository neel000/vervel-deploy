          ...
          <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <div class="navbar-bottom">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <a class="navbar-brand" href="#"><img src="/layout/images/logo.svg" alt="" /></a>
                  </div>
                  <div>
                    ...
                    <div class="navbar-collapse justify-content-center collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav d-lg-flex justify-content-between align-items-center">
                        ...
                        <li class="nav-item" v-for="i in sub" v-bind:key="i.id">
                          
                          <router-link class="nav-link" v-bind:to="`/category/${i.name}/all`">{{i.name}}</router-link>
                        </li>
                        <!--<li class="nav-item">
        ...
        <footer>
          <div class="footer-top">
            <div class="container">
              <div class="row">
                <div class="col-sm-5">
                  <img src="/layout/images/logo.svg" class="footer-logo" alt="" />
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="footer-border-bottom pb-2">
                        <div class="row">
                          <div class="col-3">
                            <img src="/layout/images/dashboard/home_1.jpg" alt="thumb" class="img-fluid" />
                          </div>
                          <div class="col-9">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="footer-border-bottom pb-2 pt-2">
                        <div class="row">
                          <div class="col-3">
                            <img src="/layout/images/dashboard/home_2.jpg" alt="thumb" class="img-fluid" />
                          </div>
                          <div class="col-9">
                            <h5 class="font-weight-600">
                              Cotton import from USA to soar was American traders
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div>
                        <div class="row">
                          <div class="col-3">
                            <img src="/layout/images/dashboard/home_3.jpg" alt="thumb" class="img-fluid" />
                          </div>
                          <div class="col-9">
...
import axios from 'axios'
  export default {
    ...
    mounted(){
      axios.get('https://news.coder-i.com/newsapi/category/')
        .then(response => {
